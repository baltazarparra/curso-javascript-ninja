...
*/
var nam = 'livro1';
console.log("O livro " + nam + " tem " + book(nam).quantidadePaginas + " páginas!");
...
*/
console.log("O autor do livro " + nam + " é " + book(nam).autor);
...
*/
console.log("O livro " + nam + " foi publicado pela editora " + book(nam).editora);
