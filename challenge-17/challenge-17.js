(function(){
    ...
    */
    ...
    var addName = text.replace('Manuel', 'Sataniel');
    console.log(addName);
    ...
    */
    ...
    var paulista = text.replace('brasileiro', 'paulistano');
    ...
    */
    ...
    var dh = text.replace(/[D-Za-h]/g, '0');
    console.log(dh);
    ...
    */
    ...
    var caixa = text.replace(/O Centauro de Luvas/, function(item){
    ...
    */
    ...
    console.log('O mês de março é representado pelo número ' + getMonthNumber('mar') + '.');
